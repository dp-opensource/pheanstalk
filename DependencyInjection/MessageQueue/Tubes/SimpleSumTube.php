...
use DigitalPioneers\PheanstalkBundle\DependencyInjection\MessageQueue\Worker\SimpleSumWorker;
 ...
 *  @example;
 *  $queue = $this->get('pheanstalk.queue'); // @var $queue \DigitalPioneers\PheanstalkBundle\DependencyInjection\MessageQueue\Pheanstalk
